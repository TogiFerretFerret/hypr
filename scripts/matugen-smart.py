...
def generate_discord_css(colors):
    ...
    primary = colors.get("primary", "#0ed2f7")
    tertiary = colors.get("tertiary", "#f4569d")
    error = colors.get("error", "#982929")
    primary_container = colors.get("primary_container", "#1e63b3")
